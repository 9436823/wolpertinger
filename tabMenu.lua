...
function tabMenu:renderToGroup(group)
	local data = {}
	data.menuItems = {{id="a", img = "a.png", content = {{id="a_1", callbacks="olo", img = "b.png"}, {id="a_2", callbacks="olo2", img = "c.png" }}},{id="b", img = "b.png"},{id="c", img = "c.png"},{id ="d", img = "d.png"}}
	...
	for k, item in pairs(data.menuItems) do
		...
		local function selectItem()
			...
			if item.content == nil 
				...
				local d1 = displayItem.new("a.png")--needs a better constructor 
